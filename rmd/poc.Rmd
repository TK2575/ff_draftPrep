...
write_rds(scrape, here::here("out", paste0("scrape-", Sys.Date(), ".Rds")))
```

```{r projections}
#TODO evaluate projections_table.vor_baseline
#TODO DST points by yards allowed
...
#TODO convert to single row per player

write_csv(projections, here::here("out", paste0("projections-", Sys.Date(), ".csv")))
```